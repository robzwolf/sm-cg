...
CG.draw = {
    ...
    "walls": function(gl, viewProjMatrix, u_MvpMatrix, u_NormalMatrix, u_ModelMatrix) {
        ...
        CG.draw.box(gl, n, 60.0, 15.0, 1.0, viewProjMatrix, u_MvpMatrix, u_NormalMatrix, u_ModelMatrix);
        ...
        CG.draw.box(gl, n, 60.0, 1.0, 4.0, viewProjMatrix, u_MvpMatrix, u_NormalMatrix, u_ModelMatrix);
